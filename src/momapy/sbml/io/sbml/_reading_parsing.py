...
def get_prefix_and_name(tag: str) -> tuple[str, str]:
    prefix, name = tag.split("}")
    return prefix[1:], name


def get_description(rdf: typing.Any) -> typing.Any:
    return getattr(rdf, "Description", None)


def get_bags(bq_element: typing.Any) -> list[typing.Any]:
    return list(getattr(bq_element, f"{{{_RDF_NAMESPACE}}}Bag", []))


def get_list_items(bag: typing.Any) -> list[typing.Any]:
...
def get_annotation(sbml_element: typing.Any) -> typing.Any:
    return getattr(sbml_element, "annotation", None)


def get_species(sbml_model: typing.Any) -> list[typing.Any]:
...
def get_reactions(sbml_model: typing.Any) -> list[typing.Any]:
...
def get_compartments(sbml_model: typing.Any) -> list[typing.Any]:
...
def get_reactants(sbml_reaction: typing.Any) -> list[typing.Any]:
...
def get_products(sbml_reaction: typing.Any) -> list[typing.Any]:
...
def get_modifiers(sbml_reaction: typing.Any) -> list[typing.Any]:
...
def get_notes(sbml_element: typing.Any) -> typing.Any:
    return getattr(sbml_element, "notes", None)


def get_rdf(sbml_element: typing.Any) -> typing.Any:
