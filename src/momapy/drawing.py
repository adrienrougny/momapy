...
class DrawingElement(abc.ABC):
    ...
    font_weight: FontWeight | float | None = dataclasses.field(
        default=None,
    ...
    stroke_dasharray: tuple[float] | None = dataclasses.field(
        default=None,
        metadata={
            "description": "The stroke dasharray of the drawing element"
        },
    )
    stroke_dashoffset: float | None = dataclasses.field(
        default=None,
        metadata={
            "description": "The stroke dashoffset of the drawing element"
        },
    )
...
class EllipticalArc(PathAction):
    ...
    x_axis_rotation: float = dataclasses.field(
        metadata={
            "description": "The x axis rotation of the elliptical arc action"
        }
    )
...
class CurveTo(PathAction):
    ...
    control_point1: momapy.geometry.Point = dataclasses.field(
        metadata={
            "description": "The first control point of the curve to action"
        }
    )
    control_point2: momapy.geometry.Point = dataclasses.field(
        metadata={
            "description": "The second control point of the curve to action"
        }
    )
...
class QuadraticCurveTo(PathAction):
    ...
    control_point: momapy.geometry.Point = dataclasses.field(
        metadata={
            "description": "The control point of the quadratic curve to action"
        }
    )
...
class Rectangle(DrawingElement):
    ...
    rx: float = dataclasses.field(
        metadata={
            "description": "The x-radius of the rounded corners of the rectangle"
        }
    )
    ry: float = dataclasses.field(
        metadata={
            "description": "The y-radius of the rounded corners of the rectangle"
        }
    )
