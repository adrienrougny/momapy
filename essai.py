...
l = LayoutBuilder(fill=colors.light_salmon, stroke=colors.green_yellow, stroke_width=3)
r1 = RectangleBuilder(position=Point(100, 100), width=100, height=50, fill=colors.blue)
for i in range(0, 360, 10):
    r = RectangleBuilder(position=r1.angle(i), width=5, height=5, stroke=colors.red)
    r1.add_element(r)


r3 = RectangleBuilder(position=Point(300, 300), width=100, height=50, fill=colors.yellow_green)
