...
a.points.append(right_of(a.points[0], 20))
a.points.append(r3.border(r1.center()))

r4 = RectangleBuilder(width=20, height=10, fill=colors.sky_blue)
r5 = RectangleBuilder(width=20, height=10, fill=colors.yellow)
set_position_at_fraction_of(r4, a, 0.5, anchor="south_west")
set_position_at_fraction_of(r5, a, 0.5)
a.add_element(r4)
